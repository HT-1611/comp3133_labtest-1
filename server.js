...
// MongoDB Connection
const MONGO_URI = "mongodb+srv://harshilpadsala07:Harshil%409724@lab3cluster.ewhl8.mongodb.net/chatapp?retryWrites=true&w=majority&appName=Lab3Clustere";
...
io.on("connection", (socket) => {
    ...
    socket.on("chatMessage", async ({ from_user, room, message }) => {
        ...
        if (chatbotResponses[lowerCaseMessage]) {
            ...
            io.to(room).emit("message", { from_user: "Chatbot", message: chatbotResponses[lowerCaseMessage] });
        }
